...
export default function Home() {
  return (
    <Layout>
      <main className="w-full px-2 sm:px-4 py-4 sm:py-6 bg-gray-50">
        {/* Always on top */}
        <Header />
        ...
        <div className="flex flex-col lg:flex-row gap-4 mt-6 w-full">
          {/* Timeline section */}
          <div className="w-full lg:flex-[2] min-w-0  bg-white">
            <Timeline />
          </div>

          {/* CommentSider section */}
          <div className="w-full lg:flex-[1] min-w-0 bg-white">
            <CommentSider />
          </div>
        </div>
      </main>
